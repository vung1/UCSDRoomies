  ...
  return (
    ...
    <View>
      ...
      <ScrollView style={styles.scrollContainer} horizontal> 
        <View style={styles.scrollImage}><AddImage saveImage={setHouseImage1}/></View>
        <View style={styles.scrollImage}><AddImage saveImage={setHouseImage2}/></View>
        <View style={styles.scrollImage}><AddImage saveImage={setHouseImage3}/></View>
        <View style={styles.scrollImage}><AddImage saveImage={setHouseImage4}/></View>
      </ScrollView>
